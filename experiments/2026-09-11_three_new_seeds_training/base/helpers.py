...
PARENT=Path('/home/king/Downloads/Projects/2_th_paper_TMC/experiments/2026-09-10_sequential_long_training')
...
def config(arm='joint',seed=810974): return read(HERE/'configs'/f'seed_{seed}'/f'{arm}.json')
