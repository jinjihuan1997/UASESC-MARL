...
class TensorSCEnv:
    ...
    def observe(self):
        ...
        # Same g-independent minimum-load proxy as the CPU implementation.
        pending=self.load.amin(-1)*self.q.sum(-1)
        ...
        masks[:,0,:U]=1
        # All profile modes are proposals; common executor applies task QoS.
        masks[:,1:,:M]=1
