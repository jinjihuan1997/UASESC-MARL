...
SD_XL_BASE_RATIOS = {
    ...
    "0.88": (960, 1088),
    "0.94": (960, 1024),
    "condition_1.0": (1024, 1024),
    "condition_1.07": (1024, 960),
    "condition_1.13": (1088, 960),
    "condition_1.21": (1088, 896),
    "condition_1.29": (1152, 896),
    "condition_1.38": (1152, 832),
    "condition_1.46": (1216, 832),
    "condition_1.67": (1280, 768),
    "condition_1.75": (1344, 768),
    "condition_1.91": (1344, 704),
    "2.0": (1408, 704),
    "2.09": (1472, 704),
    "2.4": (1536, 640),
    "2.5": (1600, 640),
...
def run_img2img(
    ...
    if st.button("Sample"):
        out = do_img2img(
            repeat(img, "condition_1 ... -> n ...", n=num_samples),
            state["model"],
            sampler,
            value_dict,
            num_samples,
...
if __name__ == "__main__":
    ...
    if add_pipeline:
        st.write("__________________________")
        version2 = st.selectbox("Refiner:", ["SDXL-refiner-condition_1.0", "SDXL-refiner-0.9"])
        st.warning(
