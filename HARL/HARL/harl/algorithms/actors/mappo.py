...
class MAPPO(OnPolicyBase):
    ...
    def train(self, actor_buffer, advantages, state_type):
        """Perform a training SC for non-parameter-sharing MAPPO using minibatch GD.
        Args:
    ...
    def share_param_train(self, actor_buffer, advantages, num_agents, state_type):
        """Perform a training SC for parameter-sharing MAPPO using minibatch GD.
        Args:
        ...
        elif state_type == "EP" and self.use_instruction_adv_norm:
            advantages_list = []
            for agent_id in range(num_agents):
                advantages_list.append(advantages.copy())
        elif state_type == "FP":
            advantages_list = []
            for agent_id in range(num_agents):
