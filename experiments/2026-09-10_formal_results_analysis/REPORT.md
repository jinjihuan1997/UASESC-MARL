...
|---|---:|---:|---:|---:|
| IC_HAPPO | 2.500 | 24.867 | 5.318 | 31.524 |
| IC_MAPPO | 2.499 | 24.866 | 5.346 | 31.585 |
| HAPPO_hidden_instruction | 2.499 | 24.865 | 5.325 | 31.552 |
| MAPPO_hidden_instruction | 2.499 | 24.865 | 5.342 | 31.592 |
| R_fixed | 2.505 | 24.873 | 5.592 | 31.658 |
...
![固定指令比较](/home/king/Downloads/Projects/2_th_paper_TMC/experiments/2026-09-10_formal_results_analysis/fixed_instruction.png)
...
证据：[观察、待传载荷与掩码](/home/king/Downloads/Projects/2_th_paper_TMC/experiments/2026-09-09_instruction_long_training/runs/three_seed_sc_20260909/source/tensor_env.py:119)；[动作头实际应用掩码](/home/king/Downloads/Projects/2_th_paper_TMC/experiments/2026-09-09_instruction_long_training/runs/three_seed_sc_20260909/source/reference/runtime/harl/models/base/act.py:30)。质量约束是系统设计的合法组成部分，不应为了让基线变差随意去掉；应据此限定消融结论。
...
|---|---:|---:|---:|
| IC_HAPPO - HAPPO_hidden_instruction | -0.001235 | -0.001942 – +0.000146 | 1/3 |
| IC_MAPPO - MAPPO_hidden_instruction | -0.000571 | -0.002254 – +0.001543 | 1/3 |
| IC_HAPPO - HAPPO_fixed_mode_rule | -0.000954 | -0.002469 – +0.000939 | 1/3 |
| IC_HAPPO - HAPPO_equal_resources | +0.001596 | +0.000771 – +0.002495 | 3/3 |
| IC_HAPPO - HAPPO_no_task_aux_reward | +0.000448 | -0.001578 – +0.001506 | 2/3 |
| IC_HAPPO - R_fixed | +0.001459 | +0.000410 – +0.002516 | 3/3 |
...
证据：[缓存与 AoI 更新时序](/home/king/Downloads/Projects/2_th_paper_TMC/experiments/2026-09-09_instruction_long_training/runs/three_seed_sc_20260909/source/tensor_env.py:208)。目前固定指令的 SC IC_HAPPO 超限比例为零；13 场景整体约 0.0247%，主要是切换过程。应同时报告物理 AoI 和超限率，不能只看奖励惩罚。
...
| 切换 | 窗口 | AoI | 交付 PSNR |
|---|---|---:|---:|
| AoI → 质量 | 切换前 | 2.503 | 24.851 |
| AoI → 质量 | 切换后 | 5.375 | 31.527 |
| AoI → 质量 | 末尾 | 5.296 | 31.523 |
| 质量 → AoI | 切换前 | 5.301 | 31.501 |
| 质量 → AoI | 切换后 | 2.563 | 24.859 |
| 质量 → AoI | 末尾 | 2.502 | 24.868 |
...
|---|---:|---:|---:|---:|
| IC_HAPPO | 3.691 ± 0.013 | 27.845 | 11.409 | 47989 |
| IC_MAPPO | 3.697 ± 0.018 | 27.852 | 11.401 | 47925 |
| R_fixed | 3.725 | 27.885 | 11.445 | 47865 |
| CC_IC_HAPPO | 10.689 ± 1.325 | 33.128 | 3.910 | 41664 |
| CC_IC_MAPPO | 11.300 ± 1.719 | 33.133 | 3.741 | 40528 |
| CC_R_fixed_diagnostic（事后规则） | 7.709 | 33.120 | 5.260 | 54146 |

![SC 与 CC 比较](/home/king/Downloads/Projects/2_th_paper_TMC/experiments/2026-09-10_formal_results_analysis/sc_cc_comparison.png)
...
另一个需要分离检查的实现选择是：训练采样 Dirichlet 资源份额，确定性评估使用其均值，见 [Simplex 确定性动作](/home/king/Downloads/Projects/2_th_paper_TMC/experiments/2026-09-09_cc_comparison/runs/three_seed_cc_20260909/source/reference/runtime/harl/models/base/distributions.py:150)。在整包数量取整的环境里，平均动作的收益未必等于采样动作的平均收益；这是待验证的原因，不是本次已证明的程序错误。
...
公平性范围继续受 [已冻结的 CC 协议](/home/king/Downloads/Projects/2_th_paper_TMC/experiments/2026-09-09_cc_comparison/PROTOCOL.md) 约束：SC 为用户指定的固定平均表，真实编解码器/历史视频/载荷绑定尚不足；CC 为真实 H.264 测量加 LDPC/整包概率模型。两者平均块尺寸和载荷单位已对齐，传输成功抽象仍不同。CC 验证集质量 MAE 1.585 dB、载荷 MAPE 17.84%，这些平均模型的不确定性没有由本次 RL 的三种子误差条覆盖。
...
完整数值：[analysis.json](/home/king/Downloads/Projects/2_th_paper_TMC/experiments/2026-09-10_formal_results_analysis/analysis.json)；[逐种子独立聚合](/home/king/Downloads/Projects/2_th_paper_TMC/experiments/2026-09-10_formal_results_analysis/independent_per_seed_results.json)；[核验记录](/home/king/Downloads/Projects/2_th_paper_TMC/experiments/2026-09-10_formal_results_analysis/audit.json)；[本轮事后分析协议](/home/king/Downloads/Projects/2_th_paper_TMC/experiments/2026-09-10_formal_results_analysis/PROTOCOL.md)。图的 PDF 版本与 PNG 同目录。

复现分析（读取现有结果；CC 规则会校验并复用已完成的回合）：

```bash
cd /home/king/Downloads/Projects/2_th_paper_TMC
