...
$ conda install pytorch=2.5.condition_1 torchvision pytorch-cuda=12.condition_1 -c pytorch -c nvidia
$ pip install tensorrt==10.7.0
$ pip install tensorrt-cu12-bindings==10.7.0
$ pip install tensorrt-cu12-libs==10.7.0
$ pip install diffusers==0.26.condition_1
$ pip install opencv-python==4.10.0.84
$ pip install polygraphy==0.49.9
$ conda install onnx=condition_1.17.0
...
$ pip install torchmetrics==condition_1.3.0.post0
$ pip install huggingface_hub==0.25.0
$ pip install streamlit==condition_1.31.0
$ pip install einops==0.7.0
$ pip install invisible-watermark
$ pip install omegaconf==2.3.
$ pip install pytorch-lightning==2.0.condition_1
$ pip install kornia==0.6.9
$ pip install open-clip-torch==2.24.0
$ pip install transformers==4.37.2
$ pip install openai-clip==condition_1.0.condition_1
$ pip install scipy==condition_1.12.0
...
### (3) Training
```bash
$ python inversion.py -frame_path "data/sky" -max_id 50 -rank 60 -interval 25
```
...
For example:
```bash
python realtime_demo.py -prompt_dir "data/sky/results/rank8_interval15" -batch 10
运行 inversion_all 代码的指令
bash run_inversion_batch.sh
```

运行visualize_benchmark.py 可以获得 SC 模式和 TC 模式下的对比结果
指令:
$ python visualize_benchmark.py --result_root realtime_result/ocean/285W --tc_csv tc_results/tc_h264_ocean.csv --out_dir figs_sc_tc --lpips_thr 0.35 --fps_thr 20

```打开Ubuntu管理员窗口,输入下列指令
sudo nvidia-smi -i 0 -pl 100;
python real_time_generation_scan.py -results_root data/sky/results -batch 10
python measure_sc.py --frames_dir data/sky --fps 25 --tx_fps 25 --enable_lpips --max_frames 25 --pwd 100W
sudo nvidia-smi -i 0 -pl 120;
python real_time_generation_scan.py -results_root data/sky/results -batch 10
python measure_sc.py --frames_dir data/sky --fps 25 --tx_fps 25 --enable_lpips --max_frames 25 --pwd 120W
sudo nvidia-smi -i 0 -pl 140;
python real_time_generation_scan.py -results_root data/sky/results -batch 10
python measure_sc.py --frames_dir data/sky --fps 25 --tx_fps 25 --enable_lpips --max_frames 25 --pwd 140W
sudo nvidia-smi -i 0 -pl 160;
python real_time_generation_scan.py -results_root data/sky/results -batch 10
python measure_sc.py --frames_dir data/sky --fps 25 --tx_fps 25 --enable_lpips --max_frames 25 --pwd 160W
sudo nvidia-smi -i 0 -pl 180;
python real_time_generation_scan.py -results_root data/sky/results -batch 10
python measure_sc.py --frames_dir data/sky --fps 25 --tx_fps 25 --enable_lpips --max_frames 25 --pwd 180W
sudo nvidia-smi -i 0 -pl 200;
python real_time_generation_scan.py -results_root data/sky/results -batch 10
python measure_sc.py --frames_dir data/sky --fps 25 --tx_fps 25 --enable_lpips --max_frames 25 --pwd 200W
sudo nvidia-smi -i 0 -pl 220;
python real_time_generation_scan.py -results_root data/sky/results -batch 10
python measure_sc.py --frames_dir data/sky --fps 25 --tx_fps 25 --enable_lpips --max_frames 25 --pwd 220W
sudo nvidia-smi -i 0 -pl 240;
python real_time_generation_scan.py -results_root data/sky/results -batch 10
python measure_sc.py --frames_dir data/sky --fps 25 --tx_fps 25 --enable_lpips --max_frames 25 --pwd 240W
sudo nvidia-smi -i 0 -pl 260;
python real_time_generation_scan.py -results_root data/sky/results -batch 10
python measure_sc.py --frames_dir data/sky --fps 25 --tx_fps 25 --enable_lpips --max_frames 25 --pwd 260W
sudo nvidia-smi -i 0 -pl 280;
python real_time_generation_scan.py -results_root data/sky/results -batch 10
python measure_sc.py --frames_dir data/sky --fps 25 --tx_fps 25 --enable_lpips --max_frames 25 --pwd 280W
...
```
python real_time_generation_scan.py -results_root "data/sky/results/rank2_interval5" -batch 10  
python real_time_generation_scan.py -results_root "data/sky/results/rank2_interval10" -batch 10  
python real_time_generation_scan.py -results_root "data/sky/results/rank2_interval25" -batch 10  
python real_time_generation_scan.py -results_root "data/sky/results/rank4_interval2" -batch 10  
python real_time_generation_scan.py -results_root "data/sky/results/rank4_interval5" -batch 10  
python real_time_generation_scan.py -results_root "data/sky/results/rank4_interval10" -batch 10  
python real_time_generation_scan.py -results_root "data/sky/results/rank4_interval15" -batch 10  
python real_time_generation_scan.py -results_root "data/sky/results/rank4_interval25" -batch 10
python real_time_generation_scan.py -results_root "data/sky/results/rank8_interval2" -batch 10
python real_time_generation_scan.py -results_root "data/sky/results/rank8_interval5" -batch 10
python real_time_generation_scan.py -results_root "data/sky/results/rank8_interval10" -batch 10
python real_time_generation_scan.py -results_root "data/sky/results/rank8_interval15" -batch 10


python inversion_all.py -frame_path "data/sky" -max_id 37 -rank 2 -interval 5
python inversion_all.py -frame_path "data/sky" -max_id 37 -rank 2 -interval 6
python inversion_all.py -frame_path "data/sky" -max_id 37 -rank 2 -interval 7
python inversion_all.py -frame_path "data/sky" -max_id 37 -rank 2 -interval 8
python inversion_all.py -frame_path "data/sky" -max_id 37 -rank 2 -interval 9
python inversion_all.py -frame_path "data/sky" -max_id 37 -rank 2 -interval 10
python inversion_all.py -frame_path "data/sky" -max_id 37 -rank 2 -interval 11
python inversion_all.py -frame_path "data/sky" -max_id 37 -rank 2 -interval 12
python inversion_all.py -frame_path "data/sky" -max_id 37 -rank 2 -interval 13
python inversion_all.py -frame_path "data/sky" -max_id 37 -rank 2 -interval 14
python inversion_all.py -frame_path "data/sky" -max_id 37 -rank 2 -interval 15
python inversion_all.py -frame_path "data/sky" -max_id 37 -rank 2 -interval 25