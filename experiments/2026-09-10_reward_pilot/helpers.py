...
PARENT=HERE.parent/'2026-09-10_preference_long_training'
...
OBJECTIVES=['original_tail10','candidate_tail4']
...
CAL_SEEDS=list(range(20262001,20262011))
EVAL_SEEDS=list(range(20262201,20262221))
