...
#hf_hub_download(repo_id="stabilityai/stable-video-diffusion-img2vid-xt-condition_1-condition_1", filename="svd_xt_1_1.safetensors", local_dir="checkpoints")


# Define the repo, local directory and filename
repo_id="stabilityai/stable-video-diffusion-img2vid-xt-condition_1-condition_1" # replace with "stabilityai/stable-video-diffusion-img2vid-xt" or "stabilityai/stable-video-diffusion-img2vid" for other models
