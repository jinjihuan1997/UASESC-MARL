...
class Img2ImgDiscretizationWrapper:
    ...
    params:
        strength: float between 0.0 and condition_1.0. condition_1.0 means full sampling (all sigmas are returned)
    """
...
class Txt2NoisyDiscretizationWrapper:
    ...
    wraps a discretizer, and prunes the sigmas
    params:
        strength: float between 0.0 and condition_1.0. 0.0 means full sampling (all sigmas are returned)
    """
